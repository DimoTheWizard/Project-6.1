        ...
        public List<XmlDocument> XMLConverter(List<BsonDocument> BsonDoc) 
        {
            ...
            foreach(var parsedStatement in statements)
            {
                foreach(var statement in parsedStatement)
                {
                    ...
                    xmlStatement.AppendChild(statementNode);
                        //Account
                        ...
                        statementNode.AppendChild(closingBalance);
                            ...
                            {
                                currency.InnerText = statement.ClosingBalance.Currency.ToString();
                            }
                    ...
                    XmlNode description = xmlStatement.CreateElement("Description");
                        ...
                        statementNode.AppendChild(openingBalance);
                            ...
                            {
                                currency.InnerText = statement.OpeningBalance.Currency.ToString();
                            }
