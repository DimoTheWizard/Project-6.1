...
namespace Sports_Accounting {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string username, string level) {
...
namespace Sports_Accounting.DatabaseDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([user_id] = @Original_user_id) AND ([username] =" +
                " @Original_username) AND ([level] = @Original_level))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[User] SET [username] = @username, [level] = @level WHERE (([user_id" +
                "] = @Original_user_id) AND ([username] = @Original_username) AND ([level] = @Ori" +
                "ginal_level));\r\nSELECT user_id, username, level FROM [User] WHERE (user_id = @us" +
                "er_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Sports_Accounting.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, username, [level] FROM dbo.[User]";
        ...
        public virtual int Delete(int Original_user_id, string Original_username, string Original_level) {
        ...
        public virtual int Update(string username, string level, int Original_user_id, string Original_username, string Original_level, int user_id) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string level, int Original_user_id, string Original_username, string Original_level) {
            return this.Update(username, level, Original_user_id, Original_username, Original_level, Original_user_id);
        }
    }
